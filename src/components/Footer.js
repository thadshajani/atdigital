                ...
                <div className="footer-top-items">
                    <div className="top">
                        <div className="aboutsec">
                            <svg id="footer-logo" width="239" height="37" viewBox="0 0 239 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M65.0254 36.5149H60.3654L70.7723 12.0069H75.6577L86.2842 36.5149H81.3988L78.6294 29.8257H70.46L72.0211 25.8884H76.9528L73.1022 16.6841L65.0254 36.5149Z" fill="white" />
                                <path d="M102.733 12.0069V15.921H95.7023V36.5149H91.1638V15.921H84.1334V12.0069H102.733Z" fill="white" />
                                ...
                                <path d="M197.846 12.0069V15.921H190.821V36.5149H186.277V15.921H179.229V12.0069H197.846Z" fill="white" />
                                ...
                                <path d="M229.158 12.0069V32.5719H238.889V36.5149H224.614V12.0069H229.158Z" fill="white" />
                            </svg>
