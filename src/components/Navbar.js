...
function Navbar() {
    return (
        <>
            <nav id="navlist">
                <a href="index.html">
                    <svg id="logo" width="239" height="37" viewBox="0 0 239 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="mobile">
                    {/* <i id="bar" className={this.state.clicked ? "fas fa-times" : "fas fa-bars"} aria-hidden="true"></i> */}
